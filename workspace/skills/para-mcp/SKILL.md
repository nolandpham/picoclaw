...
When you call `list_documents`, the output shows document numbers like `[01]`, `[02]`, etc. You can use these indices directly in other tools:
...
[02] Another Document Title (02.areas)
     Tags: area, planning
     ID: abc123def456
...
- Delete index 01: `delete_document index=1`
- Link index 01 to index 02: `link_entities from_index=1 to_index=2`
